...
# The block reward of coinbaseoutput.nValue (50) AFCO/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 AFCO/block.
BLOCKS = 101
...
class TestAFCOCli(AFCOTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `afco-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and afco-cli getwalletinfo return expected wallet info")
