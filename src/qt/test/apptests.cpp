...
//! Entry point for AFCOApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AFCOApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AFCOGUI tests.
void AppTests::guiTests(AFCOGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AFCOGUI::consoleShown, this, &AppTests::consoleTests);
