    ...
    mapper(nullptr)
{
    ...
    ui->afcoAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->afcoAtStartup);
    ...
    ui->afcoAtStartup->setToolTip(ui->afcoAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->afcoAtStartup->setText(ui->afcoAtStartup->text().arg(PACKAGE_NAME));

    ui->openAFCOConfButton->setToolTip(ui->openAFCOConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new AFCOUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->afcoAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openAFCOConfButton_clicked()
{
