...
class P2PPermissionsTests(AFCOTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].afcoconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].afcoconf, 'w', encoding="utf8") as f:
            f.write(newText)
