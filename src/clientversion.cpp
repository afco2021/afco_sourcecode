 ...
 * for both afcod and afco-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/afco/bips/blob/master/bip-0014.mediawiki)
 */
