...
{
    BOOST_CHECK(TestSplitHost("www.afcocore.org", "www.afcocore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.afcocore.org]", "www.afcocore.org", -1));
    BOOST_CHECK(TestSplitHost("www.afcocore.org:80", "www.afcocore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.afcocore.org]:80", "www.afcocore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:33584", "127.0.0.1", 33584));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:33584", "127.0.0.1", 33584));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:33584", "::ffff:127.0.0.1", 33584));
    BOOST_CHECK(TestSplitHost("[::]:33584", "::", 33584));
    BOOST_CHECK(TestSplitHost("::33584", "::33584", -1));
    BOOST_CHECK(TestSplitHost(":33584", "", 33584));
    BOOST_CHECK(TestSplitHost("[]:33584", "", 33584));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:33584", "127.0.0.1:33584"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:33584", "[::]:33584"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
