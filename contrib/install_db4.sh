...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the afco repository."
  exit 1
fi
...
# See https://github.com/afco/afco/issues/16064
...
echo 'When compiling afcod, run `./configure` in the following way:'
echo
