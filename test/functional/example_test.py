...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AFCOTestFramework
    pass


class ExampleTest(AFCOTestFramework):
    # Each functional test is a subclass of the AFCOTestFramework class.
    ...
    def custom_method(self):
        ...
        AFCOTestFramework class so other tests can use it."""
