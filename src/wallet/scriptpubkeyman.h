...
#ifndef AFCO_WALLET_SCRIPTPUBKEYMAN_H
#define AFCO_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The AFCO Core wallet was originally a collection of unrelated private
...
#endif // AFCO_WALLET_SCRIPTPUBKEYMAN_H
