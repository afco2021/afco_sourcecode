...
class TestShell:
    """Wrapper Class for AFCOTestFramework.

    The TestShell class extends the AFCOTestFramework
    ...
    class __TestShell(AFCOTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AFCOTestFramework child class.
            self.num_nodes = 1
