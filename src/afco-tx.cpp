...
static void SetupAFCOTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " afco-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  afco-tx [options] <hex-tx> [commands]  Update hex-encoded afco transaction\n" +
            "or:     afco-tx [options] -create [commands]   Create hex-encoded afco transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded afco transaction
