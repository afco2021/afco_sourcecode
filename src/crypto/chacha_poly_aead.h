...
#ifndef AFCO_CRYPTO_CHACHA_POLY_AEAD_H
#define AFCO_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@afco.
 *
 ...
 *
 * The chacha20-poly1305@afco combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@afco cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@afco are relatively fast in
...
#endif // AFCO_CRYPTO_CHACHA_POLY_AEAD_H
