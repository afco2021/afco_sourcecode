...
#ifndef AFCO_TEST_SCRIPTNUM10_H
#define AFCO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from AFCO Core 0.10.0, for cross-comparison.
 */
public:
