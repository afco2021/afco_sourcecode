...
"""Verify that starting afco with -h works as expected."""

from test_framework.test_framework import AFCOTestFramework
from test_framework.util import assert_equal

class HelpTest(AFCOTestFramework):
    ...
    def run_test(self):
        self.log.info("Start afco with -h for help text")
        ...
        self.log.info("Start afco with -version for version information")
        ...
        self.log.info("Start afcod with -fakearg to make sure it does not start")
