...
// afco includes.
#include <..\src\script\afcoconsensus.h>
...
int main()
{
    std::cout << "afcoconsensus version: " << afcoconsensus_version() << std::endl;
    ...
    auto op0Result = afcoconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, afcoconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
