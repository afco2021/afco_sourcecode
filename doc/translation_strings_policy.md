...
This document provides guidelines for internationalization of the AFCO Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `afco_en.ts` remains unchanged.
