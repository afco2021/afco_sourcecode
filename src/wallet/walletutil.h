...
#ifndef AFCO_WALLET_WALLETUTIL_H
#define AFCO_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! afco from opening the wallet, thinking it was newly created, and
...
#endif // AFCO_WALLET_WALLETUTIL_H
