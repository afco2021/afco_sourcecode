...
By default, afcod will dump mempool on shutdown and
...
class MempoolPersistTest(AFCOTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent afcod from writing mempool.dat to disk. Verify that `savemempool` fails")
