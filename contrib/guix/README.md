# Bootstrappable AFCO Core Builds

This directory contains the files necessary to perform bootstrappable AFCO
Core builds.
...
- 24GB of free disk space on the partition that the AFCO Core git repository
  resides in
...
For a AFCO Core depends development environment, simply invoke
...
From the top of a clean AFCO Core repository:
...
To use dongcarl's substitute server for AFCO Core builds after having
