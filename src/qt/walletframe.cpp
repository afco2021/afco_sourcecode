...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, AFCOGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &AFCOGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &AFCOGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &AFCOGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &AFCOGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &AFCOGUI::updateWalletStatus);
    connect(gui, &AFCOGUI::setPrivacy, walletView, &WalletView::setPrivacy);
