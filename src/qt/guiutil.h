...
#ifndef AFCO_QT_GUIUTIL_H
#define AFCO_QT_GUIUTIL_H
...
/** Utility functions used by the AFCO Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "afco:" URI into recipient object, return true on successful parsing
