    ...
    platformStyle(_platformStyle)
{
    ...
    // normal afco address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying afco address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &AFCOAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
