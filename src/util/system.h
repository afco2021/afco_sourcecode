 ...
 */
#ifndef AFCO_UTIL_SYSTEM_H
#define AFCO_UTIL_SYSTEM_H
...
extern const char * const AFCO_CONF_FILENAME;
extern const char * const AFCO_SETTINGS_FILENAME;
